...
ap.add_argument("--x_margin", type=float, help='', default=20)
ap.add_argument("--z_margin", type=float, help='', default=10)
...
x_margin_nm = x_margin*1000
z_margin_nm = z_margin*1000

mf_xlim = [xlim[0]-x_margin_nm,
           xlim[1]+x_margin_nm]

vol_zlim = [2800, 47200]
zlim = [vol_zlim[0]+z_margin_nm,
        vol_zlim[1]-z_margin_nm]
...
input_graph.add_mfs(mfs_bouton_locs, xlim=mf_xlim)
'''Make GT graph'''
...
if x_margin:
    fout_name += f'_x_margin_{x_margin}'
if z_margin:
    fout_name += f'_z_margin_{z_margin}'
