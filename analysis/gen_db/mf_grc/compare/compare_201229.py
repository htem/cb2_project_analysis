...
fname0 = f'/n/groups/htem/Segmentation/shared-nondev/cb2_segmentation/analysis_mf_grc/gen_db/mf_grc/gen_201229_setup01_syndb_threshold_20.gz'
fname1 = f'/n/groups/htem/Segmentation/shared-nondev/cb2_segmentation/analysis_mf_grc/gen_db/mf_grc/gen_201229_setup01_syndb_threshold_25.gz'
...
for grc in grcs:
    ...
    for pc in pcs:
        locs0 = set([syn['syn_loc'] for syn in pfs_pc0[grc][pc]])
        locs1 = set([syn['syn_loc'] for syn in pfs_pc1[grc][pc]])
