...
proofread_fnames = [
    '/n/groups/htem/Segmentation/shared-nondev/cb2_segmentation/analysis_mf_grc/purkinje/pfs_postsyn_orphans_200911',
    'pfs_postsyn_orphan_segments_201207',
    '/n/groups/htem/Segmentation/shared-nondev/cb2_segmentation/analysis_mf_grc/purkinje/pfs_postsyn_orphan_segments_201223_by_pf_0',
]
...
for config_f in [
        '/n/groups/htem/Segmentation/shared-nondev/cb2_segmentation/analysis_mf_grc/config_pfs_201223_setup01.json',
        ]:
...
for fragment_ids in total_orphans:
    for fid in fragment_ids:
        ...
        index = [int(index[0]/32), int(index[1]/8), int(index[2]/4)]
        if index[0] >= 2:
            index[0] = 2
        index = tuple(index)
...
with open('pfs_postsyn_orphan_segments_201228', 'w') as fout:
