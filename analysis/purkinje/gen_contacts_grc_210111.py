...
grcs_with_complete_axons_f = '/n/groups/htem/Segmentation/shared-nondev/cb2_segmentation/analysis_mf_grc/completed_neurons_with_axons_210111'
...
with open('grc_pc_touches_210111', 'w') as fout:
...
'''pickle'''
fname = 'grc_pc_touches_210111.gz'
