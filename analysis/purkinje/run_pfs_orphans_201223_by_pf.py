...
proofread_fnames = [
    ...
    'grc_with_axons_orphan_segments_201223',
    'grc_with_axons_orphan_segments_201207_combined',
    'grc_with_axons_orphan_segments',
    # 'grc_with_axons_orphan_segments_201223',
...
with open('pfs_postsyn_orphan_segments_201223_by_pf', 'w') as fout:
    for n in sorted(orphans_by_neuron.keys()):
        if len(orphans_by_neuron[n]) == 2:
            fout.write(n + '\n')
            for s in orphans_by_neuron[n]:
                fout.write(str(s) + '\n')
            fout.write('\n')
