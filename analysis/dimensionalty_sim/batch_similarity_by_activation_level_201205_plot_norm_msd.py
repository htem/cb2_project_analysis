...
db = compress_pickle.load('/n/groups/htem/Segmentation/shared-nondev/cb2_segmentation/analysis_mf_grc/dimensionality_sim/batch_similarity_by_activation_level_201205.gz')
db = db[0]
...
for activation_level in db['data'][0]:
    ...
    importlib.reload(my_plot); my_plot.my_relplot(
        ...
        height=4,
        aspect=1,
        y_axis_label='Population Correlation',
        x_axis_label='MF Input Noise (%)',
        save_filename=f'batch_similarity_by_activation_level_201205_plot_dim/{script_n}_{activation_level*100}_dim.svg',
        show=show,
        )
