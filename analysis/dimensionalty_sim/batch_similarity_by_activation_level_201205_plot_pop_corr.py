...
for activation_level in db['data'][0]:
    ...
    importlib.reload(my_plot); my_plot.my_relplot(
        ...
        save_filename=f'batch_similarity_by_activation_level_201205_plot_pop_corr/{script_n}_{activation_level*100}_pop_corr.svg',
        show=show,
        )


# plot population correlation across activation levels


asdf

def plot():
    importlib.reload(my_plot); return my_plot.my_relplot(
        mpd,
        x='noise_level',
        y='grc_pop_corr',
        hue='model',
