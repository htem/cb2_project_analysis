import argparse
import os
from batch_210617 import run_config
...
ap.add_argument("--invert_noise_mask", type=int, help='', default=1)
ap.add_argument("--weight_type", type=str, help='', default='same')
config = ap.parse_args()

if config.variation_sizes is None:
    # variation_sizes = [.1]
    # variation_sizes = [k/1000 for k in range(10, 210, 10)]
    config.variation_sizes = [k/1000 for k in range(600, 1000, 20)]
