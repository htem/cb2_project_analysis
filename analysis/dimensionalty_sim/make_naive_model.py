...
fname_precalibrated = f'models/naive_random_{config.n_grcs}_{config.n_mfs}_len_{config.dendrite_length}_seed_{config.seed}_precalibrated.gz'
fname = f'models/naive_random_{config.n_grcs}_{config.n_mfs}_len_{config.dendrite_length}_f_{int(config.activation_level*1000)}_seed_{config.seed}'
