...
fname_precalibrated = f'models/naive_random4_{config.n_grcs}_{config.n_mfs}_seed_{config.seed}_precalibrated.gz'
fname = f'models/naive_random4_{config.n_grcs}_{config.n_mfs}_f_{int(config.activation_level*1000)}_seed_{config.seed}'
