...
db = compress_pickle.load('/n/groups/htem/Segmentation/shared-nondev/cb2_segmentation/analysis_mf_grc/dimensionality_sim/batch_similarity_201205.gz')
db = db[0]
...
for model_name in ['data',
    ...
    ress = db[model_name]
    ress = ress[0]
    for similarity_level, res in ress.items():
        if int(similarity_level*100) % 3:
            continue
