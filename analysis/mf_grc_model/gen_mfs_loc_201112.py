...
config_f = "config_grc_mf_201112.json"
...
for neuron in neurons:
    postsyn_grcs |= graph.get_partners(
        neuron, 'postsyn',
        synapse_min_count=2,
        # partner_type='grc',
        # neuron_subtype='axon',
...
# print(postsyn_grcs)
print(f'Num postsyn_grcs: {len(postsyn_grcs)}')  # 160
...
compress_pickle.dump((
    mfs_bouton_locs
    ), "mfs_bouton_locs_201112.gz")


asdf

for loc in mfs_bouton_locs['mf_41']:
    print([int(loc[0]/4), int(loc[1]/4), int(loc[2]/40)])
