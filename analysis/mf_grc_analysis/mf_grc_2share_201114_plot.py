...
importlib.reload(my_plot); my_plot.my_relplot(
    mpd_true_cdf, y='count', x='num_partners', hue='kind',
    kind='line',
    ...
    save_filename='mf_grc_2share_201114_plot_cdf_true.svg',
    )

importlib.reload(my_plot); my_plot.my_catplot(
    mpd_true, y='count', x='num_partners', hue='kind',
    kind='bar',
    # kind='violin',
    # y='ratio', y_lims=[.25, .75],
    context='paper',
    ...
    y_axis_label='Cumulative Distribution',
    x_axis_label='# of other similar patterns',
    save_filename='mf_grc_2share_201114_plot_bar_true.svg',
    )
...
importlib.reload(my_plot); my_plot.my_relplot(
    ...
    y_axis_label='Cumulative Distribution',
    x_axis_label='# of other similar patterns',
    save_filename=f'mf_grc_2share_201114_plot_{n_random}_cdf.svg',
    )
...
importlib.reload(my_plot); my_plot.my_catplot(
    ...
    y_axis_label='Cumulative Distribution',
    x_axis_label='# of other similar patterns',
    save_filename=f'mf_grc_2share_201114_plot_{n_random}_bar.svg',
    )
