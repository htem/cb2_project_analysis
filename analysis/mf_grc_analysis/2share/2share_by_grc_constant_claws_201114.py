...
# for mf_dist_margin in [1000, 2000, 3000, 4000, 5000, 6000, 7000]:
for mf_dist_margin in [4000, 2000, 1000, 5000, 10000, 20000]:
    mpd_all = MyPlotData()
    ...
    importlib.reload(my_plot); my_plot.my_relplot(
        ...
        save_filename=f'{script_n}_{num_claws}_{mf_dist_margin}_{n_random}_cdf.svg',
        )
    ...
    importlib.reload(my_plot); my_plot.my_catplot(
        ...
        y_axis_label='Cumulative Distribution',
        x_axis_label='# of other similar patterns',
        save_filename=f'{script_n}_{num_claws}_{mf_dist_margin}_{n_random}_bar.svg',
        )
