...
importlib.reload(my_plot); my_plot.my_relplot(
    ...
    save_filename=f'vectors_same_mf_degree_{mf_dist_margin}_{n_random}_cdf_201114.svg',
    )
...
importlib.reload(my_plot); my_plot.my_catplot(
    ...
    y_axis_label='Cumulative Distribution',
    x_axis_label='# of other similar patterns',
    save_filename=f'vectors_same_mf_degree_{mf_dist_margin}_{n_random}_bar_201114.svg',
    )
