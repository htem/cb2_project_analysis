...
compress_pickle.dump((
    naive_data,
    ), f"2share_by_dist_naive_{n_samples}.gz")
...
compress_pickle.dump((
    random_correct_data,
    ), f"2share_by_dist_random_correct_{n_samples}.gz")
...
compress_pickle.dump((
    random_fixed_length_data,
    ), f"2share_by_dist_random_fixed_length_{n_samples}.gz")
...
compress_pickle.dump((
    random_constant_grc_degree_data,
    ), f"2share_by_dist_random_constant_grc_degree_{n_samples}.gz")
...
compress_pickle.dump((
    random_no_gt_mf_degree_data,
    ), f"2share_by_dist_random_no_gt_mf_degree_{n_samples}.gz")
