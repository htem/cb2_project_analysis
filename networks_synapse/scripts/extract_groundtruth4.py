...
if __name__ == "__main__":
    ...
    tree_json = json.load(open(folder + f"/annotations/{project}/tree_geometry.json", 'r'))
    ...
    # print(synapse_db)
    out = folder + f"/annotations/{project}/ground_truth.csv"
    n = 0
    with open(out, 'w') as file:
        file.write('pre_z,pre_y,pre_x,cleft_z,cleft_y,cleft_x,post_z,post_y,post_x\n')
