...
# sys.path.insert(0, '/n/groups/htem/Segmentation/networks/cb2_setups/lsd/lsd_repo')
...
class AddLocalShapeDescriptor(BatchFilter):
    ...
    def prepare(self, request):
        ...
        if self.unlabeled_mask:
            deps[self.unlabeled_mask] = deps[self.segmentation].copy()
