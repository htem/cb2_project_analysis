...
def train_until(max_iteration):
    ...
    # unlabeled_fr = ArrayKey('UNLABELED_FR')
    ...
    #     unlabeled_mask = ArrayKey('UNLABELED')
    ...
    #     unlabeled_mask = ArrayKey('UNLABELED_FR')
    ...
    #                     unlabeled_fr: 'volumes/labels/unlabeled'
    #                 },
    #                 {
    ...
    #                     unlabeled_fr: ArraySpec(interpolatable=False)
    #                 }
    #             ) +
    #         Normalize(raw_fr) +
    #         Pad(raw_fr, None) +
    ...
    #         Pad(unlabeled_fr, labels_padding) +
    #         RandomLocation() +
    ...
    #         xy_downsample(unlabeled_fr, (1, xy_downsample, xy_downsample), unlabeled_mask)
