...
def train_until(max_iteration):
    ...
    # x = -16
    # x = -24
    # input_shape = Coordinate((72,300-x,300-x))
    # intermediate_shape = Coordinate((52,208-x,208-x))
    # output_shape = Coordinate((20,116-x,116-x))
    ...
    #         Downsample(unlabeled_mask_fr, (1, xy_downsample, xy_downsample), unlabeled_mask)
